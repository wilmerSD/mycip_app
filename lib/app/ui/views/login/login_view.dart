      ...
      children: [
        Text('¿Olvidaste tu contraseña?',
            style: AppTextStyle(context).bold13(
                color: AppColors.quaternaryConst, fontWeight: FontWeight.w500)),
        InkWell(
          onTap: () {
          ...
          child: Text(' Recuperar aquí',
              style:
                  AppTextStyle(context).bold13(color: AppColors.primaryConst)),
        )
      ],
    );
          ...
          text: TextSpan(
            children: [
              ...
              TextSpan(
                ...
                style:
                    AppTextStyle(context).bold10(color: AppColors.granateConst),
              ),
            ],
          ),
        ));
